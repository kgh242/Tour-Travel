...
public class PackAirQuestionDTO {
	...
	private int pack_review_air_question_category;
	...
	public int getPack_review_air_question_category() {
		return pack_review_air_question_category;
	}
	public void setPack_review_air_question_category(int pack_review_air_question_category) {
